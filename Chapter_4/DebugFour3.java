...
import java.util.Scanner;
 class DebugFour3  // i removed public so the code works in older java verions
{
   public static void main(String args[])
   {
      ...
      DebugBox box2 = new FixDebugBox(w, l, h); //  i changed 'box1' to 'box2'
      ...
      box2.showVolume(box2); // i changed from 'showVolume();' to 'box2.showVolume(box2);'
   }
