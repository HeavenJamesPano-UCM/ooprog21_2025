...
//    the last one is the mode of transportation for the trip
 class DebugTrip  // i removed public so the code works in older java verions
{
   ...
   {
      this(destination, departure, DEFAULT_MODE); //i changed '(destionation) and (departure)' to '(destination, departure, DEFAULT_MODE)'
   }
