...
import java.util.Scanner;
 class DebugFour4 // i removed public so the code works in older java verions
{
   public static void main(String args[])
   {
      ...
      DebugTrip trip1;
      DebugTrip trip2;
      DebugTrip trip3; // changed from 'trip2' to 'trip3'
   ...
   public static void display(DebugTrip trip)
   {
      ...
      System.out.println("    Leaving from " + trip.getDepartureCity()); //  i changed the typo 'trp' to 'trip'
